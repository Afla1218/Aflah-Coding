...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku.add(new StoryBook("SB32F", "Hitman", 17, "Story", "Botak"));
        daftarBuku.add(new HistoryBook("HB324", "Laskar Matahari", 2, "History", "Goblin"));
        daftarBuku.add(new TextBook("TB323", "Operasi Pemuda 24", 4, "Text", "Afla"));
